...
class EmployeeService {
  ...
  private transformEmployeeData(apiData: any): EmployeeInformation {
    return {
      ...
      programId: apiData.program?.toString() || '',
        // Employment Display Names (from backend serializer)
  ...
  private transformToApiFormat(employee: Omit<EmployeeInformation, 'id'>): any {
    return {
      ...
      provincial_address: employee.provincialAddress || null,
      telephone_no: employee.telephoneNo || null,
      mobile_no: employee.mobileNo,
      email: employee.email,
      password: employee.password, // Will be handled by serializer
